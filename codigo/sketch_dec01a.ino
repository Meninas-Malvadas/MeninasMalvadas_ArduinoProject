...
void loop() {
    ...
    if (jogando){
        ...
        if(currentTime - previousTime >= interval){
             ...
             //evitar de ficar apertando direto para ganhar - jog 3 e 4
    ...
    if (digitalRead(button_jogador1) == 0 && check[0] == false){
        check[0] = true;
    ...
    if (digitalRead(button_jogador2) == 0 && check[1] == false){
        check[1] = true;
    ...
    if (digitalRead(button_jogador3) == 0 && check[2] == false){
        check[2] = true;
    ...
    if (digitalRead(button_jogador4) == 0 && check[3] == false){
        check[3] = true;
